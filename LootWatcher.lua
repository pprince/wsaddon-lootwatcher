...
function LootWatcher:OnDocLoaded()
	...
	if self.xmlDoc ~= nil and self.xmlDoc:IsLoaded() then
		...
		Apollo.RegisterSlashCommand("lwtest", "OnTestMessage", self)
...
function LootWatcher:OnLootWatcherOn()
	...
	self.wndMain:FindChild("CopyBox"):SetText(self.json.encode(tLootLog))

end

function LootWatcher:OnTestMessage()
table.insert(tLootLog,"Timestamp: " .. os.time() .. " | " .. "Test Message")
end
...
if channelCurrent:GetName() == "Loot" then
	local strMessage = ""
		...
		table.insert(tLootLog,"Timestamp: " .. os.time() .. " | " .. strMessage)
